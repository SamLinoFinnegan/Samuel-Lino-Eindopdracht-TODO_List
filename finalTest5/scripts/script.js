...
//         myMainDiv.appendChild(newLi).innerHTML = `<li> Task: ${element.description} <button class="button" id=${element._id}> <i class="fas fa-trash-alt"></i></button><li> `
//     })
//     const deleteButtons = Array.from(document.getElementsByClassName("button"));
